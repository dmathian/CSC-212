...
public class Reverse {
    ...
    public static void main(String[]args) throws FileNotFoundException, IOException{
        String inputFileName = "Cow.text";
        String outputFileName = "CowReversed.text";
    ...
    private static String [] readWordsFromFile(String inputFileName) throws FileNotFoundException{
        //eqaute a scanner with the input file
    ...
    private static String createFullFileName(String fileName) {
        ...
        String path = home + separator + "CS1Files" + separator + "CS1Data" + separator;
